...
downscaled_portraits_path = Path(__file__).resolve().parent.parent / f"{pixels}x{pixels}-portraits/"
...
for img in imgs:
    with Image.open(img) as im:
        ...
        block_size = original_size[0] // pixels  # Set block size
        ...
        upscaled.save(downscaled_portraits_path / img.name)
